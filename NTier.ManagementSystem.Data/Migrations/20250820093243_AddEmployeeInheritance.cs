    ...
    public partial class AddEmployeeInheritance : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "FreelancerEmployees",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false),
                    ContractAgency = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                    HourlyRate = table.Column<decimal>(type: "decimal(18,2)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_FreelancerEmployees", x => x.Id);
                    table.ForeignKey(
                        name: "FK_FreelancerEmployees_Employees_Id",
                        column: x => x.Id,
